...
from data_helper import load_chunk, save_chunk, NotLoadedError
...
DIR_DATA = '/scratch1/wan410/gp_dataset/' if torch.cuda.is_available() else '/Users/wan410/OneDrive - CSIRO/GP sampler/' # HPC path or local path
...
class GPDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kernel_dict = {'RBF':0, 'Periodic_Kernel':1}
        self.kernel_index = kernel_dict[kernel_name]
    ...
    def __getitem__(self, index):
        if self.is_reuse_across_epochs:
            return self.data[index], self.targets[index], self.kernel_index
